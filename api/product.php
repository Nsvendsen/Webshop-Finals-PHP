<?php
    ...
    if($requestMethod == 'POST') {  
        ...
        if($resultProd) {
            ...
            $productVar->productId = $resultProd->id; //Set product id before saving in the database.
            ...
            $productVarArray = $pvService->convertToProductVariationArray($resultProdVar); //Convert attributes names to camel case.
